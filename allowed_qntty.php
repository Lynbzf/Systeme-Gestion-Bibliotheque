                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Livres Autorisés <small>par Utilisateur</small></h2>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												...
												<form method="post" enctype="multipart/form-data" class="form-horizontal">
													...
													<button type="submit" style="margin-bottom:5px;" name="update1" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Oui</button>
													</div>
												</form>
