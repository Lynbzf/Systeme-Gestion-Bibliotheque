<?php include ('header.php'); ?>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small>Acceuil /</small> Livres Retournés
                </h3>
                </h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-users"></i> Listes de Livre</h2>
    ...
    ?>
							...
							where date_transaction BETWEEN '".$_POST['datefrom']." 00:00:01' and '".$_POST['dateto']." 23:59:59' and detail_action='Livre Rendu' order by report.report_id DESC ") or die (mysqli_error($con));
