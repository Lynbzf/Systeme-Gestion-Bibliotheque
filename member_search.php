        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
							...
							<br />
                    <div class="x_title">
                        <h2><i class="fa fa-users"></i> Information Membres</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
							<a href="add_member.php" style="background:none;">
							<button class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> Ajouter Membre</button>
							</a>
							</li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<thead>
								<tr>
									<th>Numéro de Membre / ID</th>
									<th>Nom Complet du Membre</th>
							<!--		<th>Gender</th>  -->
								...
								<td>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												...
												<a href="delete_member.php<?php echo '?user_id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Oui</a>
												</div>
										</div>
										</div>
									</div>
