...
?>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small>Acceuil /</small> Rapport de Livre Individuel
                </h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					...
					?>
					<h2>
					Nom de l'Emprunteur : <span style="color:maroon;"><?php echo $row['firstname']." ".$row['middlename']." ".$row['lastname']." (".$row['branch'].")";?></span>
					</h2>
                    ...
                    <div class="x_content">
                    	...
                    	echo "<span style='color:red;font-size:16px;font-weight:bold;font-family:Times New Roman, Times, serif;'>Le nombre total de livres empruntés est de = ".$borrow_count."</span";
					...
					<br>
						<div class="table-responsive">
							...
							<tr>
								...
								<td style="text-transform: capitalize"><?php echo $borrow_row['publisher_name']; ?></td>
							...
							if ($borrow_count <= 0){
								echo '
									<table style="float:right;">
										<tr>
											<td style="padding:10px;" class="alert alert-danger">Pas de livres empruntés.</td>
										</tr>
									</table>
								';
							} 							
