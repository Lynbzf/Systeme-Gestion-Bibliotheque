...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    if ($row && $password === $row['password']) {
        ...
        // Login failed
        $error_message = "Identifiant ou mot de passe inavlide. Veuillez réessayer.";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Système de gestion de bibliothèque - Connexion</title>
...
<body>
        ...
        <div class="login-card">
            ...
            <form method="post" action="index.php">
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-block btn-login" type="submit" name="login">SE CONNECTER</button>
                </div>
    ...
    <div class="login-footer-text">
        <p>© <?php echo date('Y'); ?> Système de gestion de bibliothèque</p>
    </div>
