                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Penalité <small>par jour</small></h2>
										...
										<div class="modal-body">
												...
												<form method="post" enctype="multipart/form-data" class="form-horizontal">
													<div class="form-group" style="margin-left:170px;">
														<label class="control-label col-md-4" for="first-name">Quantité <span class="required">*</span>
														</label>
														<div class="col-md-3">
													...
													<button type="submit" style="margin-bottom:5px;" name="submit" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Oui</button>
													</div>
												</form>
												...
												<?php
													...
													{
														echo "<script>alert('Modifié avec succès!'); window.location='settings.php'</script>";
													}
