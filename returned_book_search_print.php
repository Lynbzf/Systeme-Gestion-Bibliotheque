...
<div class = "container">
	...
	<button type="submit" id="print" onclick="printPage()">Imprimer</button>	
			<p style = "margin-left:30px; margin-top:5px; margin-bottom: 0px;font-size:14pt; font-style: italic; ">
...
<?php 
							...
							where date_transaction BETWEEN '".$_SESSION['datefrom']." 00:00:01' and '".$_SESSION['dateto']." 23:59:59' 
							and detail_action='Returned Book' 
...
<h2>
	...
	<?php 
	echo '<span style="color:blue; font-size:15px;">Préparé par :'."<br /><br /> ".$row['firstname']." ".$row['lastname']." ".'</span>';
	?>
</h2>
								<?php } ?>
