...
<?php include ('header.php'); ?>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small>Acceuil / Membres /</small> Modifier Membre
                </h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-pencil"></i> Modifier Informations Membre</h2>
  ...
  ?>
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="first-name">Numéro de Membre | ID<span class="required" style="color:red;">*</span>
                                    </label>
                                    <div class="col-md-4">
...
echo "<script>alert('Informations de l'utilisateur mises à jour avec succès!'); window.location='member.php'</script>";
}
