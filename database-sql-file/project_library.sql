...
(1, 'Lyna', '', 'Bouzefrane', '123456789012', 'lyna.bouzefrane@gmail.com', '9876543210', 'admin', 'admin123', 'admin123', 'avatar-366-456318.jpg', 'Admin', '2023-10-26 10:00:00'),
...
ALTER TABLE `borrow_book`
  ADD CONSTRAINT `borrow_book_ibfk_1`
    FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  ADD CONSTRAINT `borrow_book_ibfk_2`
