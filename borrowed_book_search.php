<?php include ('header.php'); ?>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-users"></i> Listes des Livres</h2>
						...
						<form method="POST" class="form-inline">
								...
								<button type="submit" name="search" class="btn btn-primary btn-outline"><i class="fa fa-calendar-o"></i> Chercher par Date de Connexion</button>
    ...
    ?>
							...
							where date_transaction BETWEEN '".$_POST['datefrom']." 00:00:01' and '".$_POST['dateto']." 23:59:59' and detail_action='Livre Emprunté' order by report.report_id DESC ") or die (mysqli_error($con));
