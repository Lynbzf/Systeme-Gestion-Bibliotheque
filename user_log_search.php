<?php include ('header.php'); ?>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small>Acceuil /</small> Historique
                </h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-users"></i> Historique des Bibliothécaires</h2>
                    ...
                    <div class="x_content">
						...
						<span style="float:left;">
							...
							<a href="user_log_in.php"><button class="btn btn-primary"><i class="fa fa-reply"></i> Tous les Rapports</button></a>
						</span>
							<thead>
								<tr>
    <?php
