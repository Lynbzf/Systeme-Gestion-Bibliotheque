                        <div class="col-md-6 col-sm-6 col-xs-12" style="margin-left:276px; float:left;">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Durée Autorisée <small>jours</small></h2>
							...
							?>
									...
									<div class="modal-dialog">
										...
										<div class="modal-header">
											<h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i> Modifier</h4>
										</div>
										<div class="modal-body">
												...
												<form method="post" enctype="multipart/form-data" class="form-horizontal">
													<div class="form-group" style="margin-left:170px;">
														<label class="control-label col-md-4" for="first-name">Jour(s) <span class="required">*</span>
														</label>
														<div class="col-md-3">
													...
													<button type="submit" style="margin-bottom:5px;" name="update" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Oui</button>
													</div>
												</form>
												...
												<?php
													...
													{
														echo "<script>alert('Modification effectuée avec succès !'); window.location='settings.php'</script>";
													}
